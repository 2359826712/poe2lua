local main_task= {
    ...
    tasks_data_hard = {
        ...
        ["進入伐木營地"]= {
            map_name= "C_G1_1",
            interaction_object= {"皆伐營地"},
            interaction_object_map_name= {"C_G1_town"},
            index = 5
        },
        ["與鐵匠交談"] = {
            map_name= "C_G1_town",
        ...
        ["穿過皆伐營地前往葛瑞爾林"]= {
            ...
            interaction_object= {'葛瑞爾林','凜冬狼的頭顱'},
            Boss= {'腐敗獸群．貝伊拉'},
            interaction_object_map_name= {'C_G1_4','CroneActive'},
            index = 8
        },
        ["在葛瑞爾林尋找伯爵行動的證據"]= {
            map_name= 'C_G1_4',
        ...
        ['繼續穿過纏縛陰林']= {
            ...
            Boss= {'腐敗的德魯伊'},
            interaction_object= {'不朽帝國之墓'},
            interaction_object_map_name= {'C_G1_7'},
            index = 33
        },
        ['纏縛陰林']= {
            map_name= 'C_G1_6',
        ...
        ['奧格姆農地']= {
            map_name= 'C_G1_13_1',
            interaction_object= {'奧格姆村'},
            interaction_object_map_name= {'C_G1_13_2'},
            index = 64
        },
        ['與烏娜交談以獲得獎勵']= {
            map_name= 'C_G1_town',
        ...
        ['找到村莊入口']= {
            map_name= 'C_G1_13_1',
            interaction_object= {'奧格姆村','烏娜的魯特琴盒','烏娜的魯特琴'},
            interaction_object_map_name= {'C_G1_13_2','FarmlandsUnasHutLandmarkActive'},
            index = 67
        },
        ['在皆伐與蕾堤絲交談']= {
            map_name= 'C_G1_town',
        ...
        ['釋放囚犯']= {
            ...
            interaction_object= {'把手','蕾堤絲'},
            Boss= {'劊子手'},
            interaction_object_map_name= {'C_G1_14'},
            index = 73
        },
        ['與蕾堤絲交談']= {
            map_name= 'C_G1_13_2',
        ...
        ['進入阿杜拉車隊']= {
            map_name= 'C_G2_1',
            interaction_object= {'阿杜拉車隊'},
            interaction_object_map_name= {'C_G2_town'},
            index = 93
        },
        ['與阿杜拉車隊一同前往報告中的腐化之地']= {
            map_name= 'C_G2_10_1',
        ...
        ['探索莫頓挖石場']= {
            map_name= 'C_G2_10_1',
            interaction_object= {'莫頓礦坑'},
            interaction_object_map_name= {'C_G2_10_2'},
            index = 96
        },
        ['莫頓挖石場']= {
            map_name= 'C_G2_10_1',
        ...
        ['返回車隊，與芮蘇討論封閉的古老關口']= {
            ...
            interaction_object= {'哈拉妮關口','古代封印','符文之印'},
            Boss= {'叛徒芭芭拉'},
            interaction_object_map_name= {'C_G2_3'},
            index = 111
        },
        ['前往古老關口']= {
            map_name= 'C_G2_2',
        ...
        ['前往失落的凱斯城']= {
            ...
            interaction_object= {'失落之城'},
            Boss= {'異界．干擾女王．卡巴拉'},
            interaction_object_map_name= {'C_G2_4_2','KabalaActive'},
            index = 124
        },
        ['凱斯城']= {
            map_name= 'C_G2_4_1',
        ...
        ['找出埋在黃沙之下的凱斯城入口']= {
            map_name= 'C_G2_4_2',
            interaction_object= {'掩埋神殿', '門'},
            interaction_object_map_name= {'C_G2_4_3'},
            index = 128
        },
        ...
        ['在乳齒象惡地尋找骨坑入口']= {
            map_name= 'C_G2_5_1',
            interaction_object= {'骨坑'},
            interaction_object_map_name= {'C_G2_5_2'},
            index = 139
        },
        ...
        ['返回阿杜拉車隊並與札卡交談']= {
            ...
            grid_x= 384,
            grid_y= 247,
            interaction_object= {'札卡', '七大水域之都獎勵','象牙盜匪獎勵'},
            index = 144
        },
        ['收下交還水之精髓的獎勵。']= {
            map_name= 'C_G2_town',
        ...
        ['登上戴斯哈']= {
            map_name= 'C_G2_8',
            interaction_object= {'悼念之路', '門','戰死的部下'},
            interaction_object_map_name= {'C_G2_9_1'},
            index = 169
        },
        ['悼念之路']= {
            map_name= 'C_G2_9_1',
            interaction_object= {'戴斯哈尖塔', '門'},
            interaction_object_map_name= {'C_G2_9_2_'},
            index = 170
        },
        ['穿過悼念之路']= {
            map_name= 'C_G2_9_1',
        ...
        ['在法里登人中殺出一條血路']= {
            map_name= 'C_G2_12_1',
            interaction_object= {'無畏隊先鋒'},
            interaction_object_map_name= {'C_G2_12_2'},
            index = 177
        },
        ['無畏隊先鋒']= {
            map_name= 'C_G2_12_2',
        ...
        ['進入叢林遺跡以尋找瑪特蘭水道']= {
            ...
            Boss={'神威銀拳'},
            interaction_object= {'感染荒地'},
            interaction_object_map_name= {'C_G3_2_1','SilverbackBlackfistBossActive'},
            index = 191
        },
        ['叢林遺跡']= {
            map_name= 'C_G3_3',
        ...
        ['探索叢林遺跡以尋找瑪特蘭水道']= {
            ...
            Boss={'神威銀拳'},
            interaction_object= {'感染荒地'},
            interaction_object_map_name= {'C_G3_2_1'},
            index = 193
        },
        ['感染荒地']= {
            map_name= 'C_G3_2_1',
        ...
        ['跟著運河尋找瑪特蘭水道']= {
            map_name= 'C_G3_2_1',
            interaction_object= {'龍蜥濕地'},
            interaction_object_map_name= {'C_G3_5'},
            index = 195
        },
        ['沿著運河尋找水道']= {
            map_name= 'C_G3_2_1',
        ...
        ['探索叢林邊陲，尋找龍蜥濕地']= {
            map_name= 'C_G3_5',
            interaction_object= {'吉卡尼的機械迷城'},
            interaction_object_map_name= {'C_G3_6_1'},
            index = 198
        },
        ['擊敗龍蜥．欽路錫安']= {
            map_name= 'C_G3_5',
        ...
        ['前往混沌神殿']= {
            ...
            Boss= {'龍蜥．欽路錫安','劇毒之花'},
            interaction_object= {'混沌神殿'},
            interaction_object_map_name= {'C_G3_10_Airlock'},
            index = 200
        },
        ['吉卡尼的機械迷城']= {
            map_name= 'C_G3_6_1',
        ...
        ['進入吉卡尼的機械迷城']= {
            ...
            Boss= {'龍蜥．欽路錫安','劇毒之花'},
            interaction_object= {'吉卡尼的機械迷城'},
            interaction_object_map_name= {'XyclucianBossActive', 'C_G3_6_1'},
            index = 202
        },
        ['進入機械迷城上層']= {
            map_name= 'C_G3_6_1',
        ...
        ['將小型靈魂核心放進石陣祭壇中']= {
            ...
            Boss={'遺忘的黑顎'},
            interaction_object= {'門', '小型靈魂核心', '石陣祭壇', '吉卡尼的聖域'},
            interaction_object_map_name= {'C_G3_6_2'},
            index = 208
        },
        ['深入探索機械迷城']= {
            map_name= 'C_G3_6_1',
        ...
        ['瑪特蘭水道']= {
            map_name= 'C_G3_2_1',
            interaction_object= {'瑪特蘭水道'},
            interaction_object_map_name= {'C_G3_2_2'},
            index = 221
        },
        ['進入瑪特蘭水道並找出控制機關']= {
            map_name= 'C_G3_2_1',
        ...
        ['開啟前往科佩克神殿的大門']= {
            ...
            grid_y= 324,
            interaction_object= {'門','科佩克'},
            interaction_object_map_name= {'C_G3_12'},
            index = 234
        },
        ['從寶藏獵人營地下方進入科佩克神殿']= {
            map_name= 'C_G3_12',
        ...
        ['從阿戈拉殺出血路，並找到漆黑密室']= {
            map_name= 'C_G3_16_',
            interaction_object= {'漆黑密室'},
            interaction_object_map_name= {'C_G3_17'},
            index = 250
        },
        ['漆黑密室']= {
            map_name= 'C_G3_17',
