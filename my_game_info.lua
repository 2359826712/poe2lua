...
local my_game_info = {
    ...
    hideout = {
        ...
        "G3_town", "C_G1_town", "C_G2_town", "C_G3_town"
    },
    ...
    task_area_list = {
        ...
        ["G1_6"] = {
            {"纏縛陰林", "纏縛陰林"}, "有", {446, 398}, {429, 329},
            "纏縛陰林"
        },
        ["G1_7"] = {
            {"不朽帝國之墓", "不朽帝國之墓"}, "有", {279, 503}
        },
        ["G1_8"] = {
            {"政務官陵墓", "政務官陵墓"}, "有", {185, 440},
            {302, 541}, "政務官陵墓"
        },
        ["G1_9"] = {
            {"配偶的墓室", "配偶的墓室"}, "有", {198, 524},
            {420, 730}, "配偶的墓室"
        },
        ["G1_11"] = {{"獵場", "獵場"}, "有", {320, 680}},
        ["G1_12"] = {{"弗雷索恩", "弗雷索恩"}, "有", {715, 480}},
        ["G1_13_1"] = {
            {"奧格姆農地", "奧格姆農地"}, "有", {847, 666}
        },
        ["G1_13_2"] = {{"奧格姆村", "奧格姆村"}, "有", {1010, 648}},
        ["G1_14"] = {{"宅第壁壘", "宅第壁壘"}, "有", {1214, 552}},
        ["G1_15"] = {
            {"奧格姆宅第", "奧格姆宅第"}, "有", {1156, 514},
            {1204, 752}, "奧格姆宅第"
        },
        ["G2_1"] = {
            {"瓦斯提里郊區", "瓦斯提里郊區"}, "有", {1025, 636}
        },
        ["G2_town"] = {
            {"阿杜拉車隊", "阿杜拉車隊"}, "有", {963, 629}
        },
        ["G2_2"] = {
            {"叛徒之路", "叛徒之路"}, "有", {767, 345}, {535, 432},
            "叛徒之路"
        },
        ...
        ["G2_4_2"] = {
            {"失落之城", "失落之城"}, "有", {939, 428}, {872, 491},
            "失落之城"
        },
        ["G2_4_3"] = {
            {"掩埋神殿", "掩埋神殿"}, "有", {890, 366}, {745, 429},
            "掩埋神殿"
        },
        ...
        ["G2_10_1"] = {
            {"莫頓挖石場", "莫頓挖石場"}, "有", {1355, 311}
        },
        ["G2_10_2"] = {
            {"莫頓礦坑", "莫頓礦坑"}, "有", {1455, 319}, {1276, 256},
            "莫頓礦坑"
        },
        ["G2_12_1"] = {{"無畏隊", "無畏隊"}, "有", {405, 284}},
        ["G2_12_2"] = {
            {"無畏隊先鋒", "無畏隊先鋒"}, "有", {300, 241}
        },
        ["G2_13"] = {
            {"絲克瑪試煉", "絲克瑪試煉"}, "有", {583, 689},
            {1085, 250}, "絲克瑪試煉"
        },
        ["G3_1"] = {{"風沙沼澤", "風沙沼澤"}, "有", {375, 662}},
        ["G3_town"] = {
            {"高地神塔營地", "高地神塔營地"}, "有", {780, 581}
        },
        ["G3_2_1"] = {{"感染荒地", "感染荒地"}, "有", {495, 340}},
        ["G3_2_2"] = {{"瑪特蘭水道", "瑪特蘭水道"}, "无", {843, 367}},
        ["G3_3"] = {{"叢林遺跡", "叢林遺跡"}, "有", {545, 434}},
        ["G3_4"] = {
            {"劇毒墓穴", "劇毒墓穴"}, "无", {474, 517}, {489, 456},
            "劇毒墓穴"
        },
        ...
        ["G3_6_2"] = {
            {"吉卡尼的聖域", "吉卡尼的聖域"}, "有", {265, 237},
            {111, 367}, "吉卡尼的聖域"
        },
        ["G3_7"] = {{"阿札克泥沼", "阿札克泥沼"}, "有", {754, 235}},
        ["G3_8"] = {{"淹沒之城", "淹沒之城"}, "有", {915, 615}},
        ["G3_9"] = {
            {"熔岩寶庫", "熔岩寶庫"}, "有", {920, 536}, {970, 528},
            "熔岩寶庫"
        },
        ["G3_10_Airlock"] = {
            {"混沌神殿", "混沌神殿"}, "有", {153, 293}, {285, 73},
            "混沌神殿"
        },
        ["G3_11"] = {{"污垢頂峰", "污垢頂峰"}, "有", {1096, 524}},
        ["G3_12"] = {
            {"科佩克神殿", "科佩克神殿"}, "无", {784, 698},
            {830, 686}, "高地神塔"
        },
        ["G3_14"] = {{"奧札爾", "奧札爾"}, "有", {915, 615}},
        ["G3_16"] = {{"阿戈拉", "阿戈拉"}, "有", {1097, 524}},
        ["G3_17"] = {
            {"漆黑密室", "漆黑密室"}, "有", {1140, 610}, {1132, 651},
            "漆黑密室"
        },
        ...
        ["C_G1_8"] = {
            {"政務官陵墓", "政務官陵墓"}, "有", {185, 446},
            {302, 541}, "政務官陵墓"
        },
        ["C_G1_9"] = {
            {"配偶的墓室", "配偶的墓室"}, "有", {162, 500},
            {420, 729}, "配偶的墓室"
        },
        ["C_G1_11"] = {{"獵場", "獵場"}, "有", {357, 663}},
        ["C_G1_12"] = {{"弗雷索恩", "弗雷索恩"}, "有", {715, 480}},
        ["C_G1_13_1"] = {
            {"奧格姆農地", "奧格姆農地"}, "有", {848, 666}
        },
        ["C_G1_13_2"] = {{"奧格姆村", "奧格姆村"}, "有", {1051, 547}},
        ["C_G1_14"] = {{"宅第壁壘", "宅第壁壘"}, "有", {1215, 552}},
        ["C_G1_15"] = {
            {"奧格姆宅第", "奧格姆宅第"}, "有", {1157, 515},
            {1204, 752}, "奧格姆宅第"
        },
        ["C_G2_1"] = {
            {"瓦斯提里郊區", "瓦斯提里郊區"}, "有", {1111, 699}
        },
        ["C_G2_town"] = {
            {"阿杜拉車隊", "阿杜拉車隊"}, "有", {1047, 693}
        },
        ["C_G2_2"] = {
            {"叛徒之路", "叛徒之路"}, "有", {569, 484}, {535, 432},
            "叛徒之路"
        },
        ...
        ["C_G2_4_2"] = {
            {"失落之城", "失落之城"}, "有", {829, 439}, {872, 491},
            "失落之城"
        },
        ["C_G2_4_3"] = {
            {"掩埋神殿", "掩埋神殿"}, "有", {918, 362}, {744, 429},
            "掩埋神殿"
        },
        ["C_G2_5_1"] = {
            {"乳齒象惡地", "乳齒象惡地"}, "有", {870, 635}
        },
        ["C_G2_5_2"] = {{"骨坑", "骨坑"}, "有", {777, 729}},
        ["C_G2_6"] = {{"泰坦之谷", "泰坦之谷"}, "有", {1112, 375}},
        ["C_G2_7"] = {
            {"泰坦石窟", "泰坦石窟"}, "有", {1168, 353}, {1051, 425},
            "泰坦石窟"
        },
        ["C_G2_8"] = {{"戴斯哈", "戴斯哈"}, "有", {348, 462}},
        ["C_G2_9_1"] = {{"悼念之路", "悼念之路"}, "有", {225, 383}},
        ["C_G2_9_2_"] = {
            {"戴斯哈尖塔", "戴斯哈尖塔"}, "有", {324, 364}
        },
        ["C_G2_10_1"] = {
            {"莫頓挖石場", "莫頓挖石場"}, "有", {1355, 311}
        },
        ["C_G2_10_2"] = {
            {"莫頓礦坑", "莫頓礦坑"}, "有", {1456, 318}, {1276, 256},
            "莫頓礦坑"
        },
        ...
        ["C_G3_3"] = {
            {"叢林遺跡（現今）", "叢林遺跡"}, "有", {466, 468}
        },
        ["C_G3_4"] = {
            {"劇毒墓穴（現今）", "劇毒墓穴"}, "无", {404, 409},
            {488, 423}, "劇毒墓穴（現今）"
        },
        ["C_G3_5"] = {
            {"龍蜥濕地（現今）", "龍蜥濕地"}, "有", {356, 306}
        },
        ["C_G3_6_1"] = {
            {"吉卡尼的機械迷城（現今）", "吉卡尼的機械迷城"},
            "有", {300, 225}
        },
        ["C_G3_6_2"] = {
            {"吉卡尼的聖域（現今）", "吉卡尼的聖域"}, "有",
        ...
        ["C_G3_8"] = {
            {"淹沒之城（現今）", "淹沒之城"}, "有", {993, 668}
        },
        ["C_G3_9"] = {
            {"熔岩寶庫（現今）", "熔岩寶庫"}, "有", {920, 509},
            {970, 499}, "熔岩寶庫（現今）"
        },
        ["C_G3_10_Airlock"] = {
            {"混沌神殿（現今）", "混沌神殿"}, "有", {152, 264},
            {285, 45}, "混沌神殿（現今）"
        },
        ["C_G3_11"] = {
            {"污垢頂峰（現今）", "污垢頂峰"}, "有", {1097, 494}
        },
        ["C_G3_12"] = {
            {"科佩克神殿（現今）", "科佩克神殿"}, "无",
        ...
        ["C_G3_14"] = {
            {"奧札爾（過去）", "奧札爾"}, "有", {992, 728}
        },
        ["C_G3_16_"] = {
            {"阿戈拉（過去）", "阿戈拉"}, "有", {1097, 554}
        },
        ["C_G3_17"] = {
            {"漆黑密室（過去）", "漆黑密室"}, "有", {1140, 639},
            {1132, 681}, "漆黑密室（過去）"
        },
        ["G_Endgame_Town"] = {
            {"高地神塔庇護所（過去）", "高地神塔庇護所"},
    ...
    scan_map_list = {
        ...
        "G1_11", "G1_12", "G1_13_1", "G1_13_2", "G1_14", "G1_15", "G2_1",
        "G2_2", "G2_3", "G2_3a", "G2_4_1", "G2_4_2", "G2_4_3", "G2_5_1",
        "G2_5_2", "G2_6", "G2_7", "G2_8", "G2_9_1", "G2_9_2", "G2_10_1",
        "G2_10_2", "G2_12_1", "G2_12_2", "G2_13", "G3_1", "G3_2_1", "G3_2_2",
        "G3_3", "G3_4", "G3_5", "G3_6_1", "G3_6_2", "G3_7", "G3_8", "G3_9",
        "G3_10_Airlock", "G3_11", "G3_12", "G3_14", "G3_16", "G3_17", "C_G1_1",
        "C_G1_2", "C_G1_3", "C_G1_4", "C_G1_5", "C_G1_6", "C_G1_7", "C_G1_8",
        "C_G1_9", "C_G1_11", "C_G1_12", "C_G1_13_1", "C_G1_13_2", "C_G1_14",
        "C_G1_15", "C_G2_1", "C_G2_2", "C_G2_3", "C_G2_3a", "C_G2_4_1",
        "C_G2_4_2", "C_G2_4_3", "C_G2_5_1", "C_G2_5_2", "C_G2_6", "C_G2_7",
        "C_G2_8", "C_G2_9_1", "C_G2_9_2_", "C_G2_10_1", "C_G2_10_2",
        "C_G2_12_1", "C_G2_12_2", "C_G2_13", "C_G3_1", "C_G3_2_1", "C_G3_2_2",
        "C_G3_3", "C_G3_4", "C_G3_5", "C_G3_6_1", "C_G3_6_2", "C_G3_7",
        "C_G3_8", "C_G3_9", "C_G3_10_Airlock", "C_G3_11", "C_G3_12", "C_G3_14",
        "C_G3_16_", "C_G3_17"
    },
    ...
    not_need_identify = {
        "StackableCurrency", "ItemisedSanctum", "UncutSkillGem",
        "UncutReservationGem", "UncutSupportGem", "Active Skill Gem",
    ...
    equip_type = {
        ...
        "LifeFlask", "ManaFlask", "Spear", "Buckler"
    },
    ...
    StackableCurrency_CN = {
        "寶石匠的稜鏡", "玻璃彈珠", "奧術蝕刻師", "磨刀石",
        "護甲片", "機率碎片", "工匠碎片", "富豪石碎片",
        "蛻變石碎片", "完美工匠石", "高階工匠石",
        "低階工匠石", "卡蘭德的魔鏡", "破裂石", "巧匠石",
        "無效石", "機會石", "神聖石", "點金石", "瓦爾寶珠",
        "混沌石", "崇高石", "富豪石", "蛻變石", "增幅石",
        "知識卷軸"
    },
    ...
    Fragment_CN = {
        ...
        "澤洛克的寶庫鑰匙：祝福之絆",
        "澤洛克的寶庫鑰匙：沙瀑面紗",
        "澤洛克的寶庫鑰匙：力抗黑暗", "仲裁者的寶庫鑰匙",
        "奧爾羅斯的寶庫鑰匙", "湯馬祖的寶庫鑰匙",
        "儀式寶庫鑰匙", "試煉大師的寶庫鑰匙",
        "烈許的寶庫鑰匙", "黎明寶庫鑰匙", "風化危機碎片",
        "褪色危機碎片", "遠古危機碎片", "勝利之運",
        "致命之運", "怯懦之運", "晉見帝王"
    },
    ...
    Essence_CN = {
        "錯亂精髓", "極恐精髓", "譫妄精髓", "浮誇精髓",
        "高階迅捷精髓", "高階毀滅精髓", "高階巫術精髓",
        "高階戰鬥精髓", "高階折磨精髓", "高階電能精髓",
        "高階寒冰精髓", "高階烈焰精髓", "高階無限精髓",
    ...
    -- # 徵兆
    Sign_CN = {
        "密室之兆", "增援之兆", "狩獵之兆", "回應祈禱之兆",
        "大幅提升之兆", "右旋廢止之兆", "左旋廢止之兆",
        "右旋抺除之兆", "左旋抺除之兆", "削切之兆",
        "大幅廢止之兆", "右旋提升之兆", "左旋提升之兆",
        "改善之兆", "腐化之兆", "復興之兆", "刷新之兆",
        "右旋加冕之兆", "左旋加冕之兆", "右旋煉金之兆",
        "左旋煉金之兆"
    },
