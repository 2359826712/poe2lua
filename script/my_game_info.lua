...
local my_game_info = {
    ...
    mian_task = {
        ...
        "招募艾茲麥人","開闢道路","招募馬拉克斯人","招募瓦爾人","狂嗥之風","奧瑞亞圍城戰","靈魂深井"
    },
    ...
    Gemstone_CN = {
        ...
        "澤洛克的克制","阿茲里的魅惑","漢恩的城塞","德瑞索的熱情",
        "烏特雷的占卜術","烏特雷的徵兆","烏特雷的出走","瑞佛的狂暴",
        "特卡蒂的憤怒","卡洛翰的決心","萊基亞塔的流動","烏爾尼多的擁抱",
        "托沃的崩裂","艾許的光芒","索伏的燃焰","骷髏馬克的支配",
        "卡莉莎的漸強","達拉的渴望","派蒂的慈悲","塔赫亞的照顧",
        "羅米拉的報復","薩雷許的折磨","西奧妮的鍛鍊","岡姆的癲狂",
        "亞瓊的獎章","菈妲的強襲","德瑞的毀滅","特克羅德的復仇",
        "艾里絲的管鐘","范尼達的奮進","帕科特的協議","厄羅克的鍛鍊",
        "布魯特斯的腦","埃哈的野獸儀式","阿特路伊的出血",
    },
