...
local config_path = script_dir .. "Settings.ini"
...
local lines = poe2_api.check_Setting_config(config_path)
local level = lines["level"]
local steam_path = lines["steam_path"]
